...
class ExecTimer:
    ...
    def __init__(self, timing_enabled=True):
        ...
        If subparts of functions have to be timed -> hand it over to subfunction.
        Args:
            timing_enabled (bool, optional):    If timing_enabled is set to false
                                                timing is deactivated completely.
                                                Defaults to True.
        """
        self.running = {}
        self.finished = {}
    ...
    def start_timer(self, label):
        ...
        Args:
            label (str): label of the timer.
                        ...
                        e.g label1/label2
                        The timing dictionary then is assembled in this structure.
        """
